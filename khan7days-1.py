...
os.system('clear')
psb('\x1b[1;32m -- BANGLADESH 11 DIGIT CLONING START PLEASE WAIT ......')
...
def menu():
    ...
    print '\x1b[1;92mAUTHOR  : TEAM KHAN'
    print '\x1b[1;92mFACEBOOK  : KHAN WHITE HAT HACKERS TEAM'
    print '\x1b[1;92mGITHUB  : github.com/khanwhitehathackersteam'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
